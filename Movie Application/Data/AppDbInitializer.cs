            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Cinemas.Any())
                {
                    context.Cinemas.AddRange(new List<Cinema>()
                    {
                        new Cinema()
                        {
                            ...
                            Decription = "This is the Decription of the first cinema"
                        },
                        new Cinema()
                        {
                            Name = "Cinema 2",
                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>()
                    {
                        ...
                        {
                            Name = "Life",
                            Decription = "This is the Life movie Decription",
                            Price = 39.50,
                        ...
                        new Movie()
                        {
                            ...
                            Decription = "This is the Shawshank Redemption Decription",
                            Price = 29.50,
                        ...
                        {
                            Name = "Ghost",
                            Decription = "This is the Ghost movie Decription",
                            Price = 39.50,
                        ...
                        {
                            Name = "Race",
                            Decription = "This is the Race movie Decription",
                            Price = 39.50,
                        ...
                        {
                            Name = "Scoob",
                            Decription = "This is the Scoob movie Decription",
                            Price = 39.50,
                        ...
                        {
                            Name = "Cold Soles",
                            Decription = "This is the Cold Soles movie Decription",
                            Price = 39.50,
